...
// schema browser inserts an unquoted `local.<name>` reference.
// Uncommon edge cases can still be solved by the user wrapping the
// identifier in double quotes; this list covers DML/DDL keywords
// likely to appear as a literal filename (update.csv, insert.csv).
